...
// Memuat data dari database menggunakan function query() dari file function.php
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
    <div class="container">
        <a class="navbar-brand" href="/">FASILKOM UNEJ</a>
...
<!-- Close Navbar -->
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Mahasiswa FASILKOM</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="views/ubah.php?nim=<?= $row['nim']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="controllers/index.php">FASILKOM UNEJ</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="controllers/index.php">Home</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <hr>
                    <a href="controllers/index.php" class="btn btn-secondary">Kembali</a>
